...
[
    ...
    { title: 'Occupant Physical Condition: Suspected Minor Injury', fieldName: 'occupant_phys_cond_moderate_injury', query: function (input) { return createQueryClauseSingleton(this, tableName, input, ">"); } },
    { title: 'Occupant Physical Condition: Possible Injury', fieldName: 'occupant_phys_cond_complaint_pain', query: function (input) { return createQueryClauseSingleton(this, tableName, input, ">"); } },
    ...
    { title: 'Pedestrian Physical Condition: Fatal Injury', fieldName: 'pedestrian_phys_cond_killed', query: function (input) { return createQueryClauseSingleton(this, tableName, input, ">"); } },
    { title: 'Pedestrian Physical Condition: Suspected Serious Injury', fieldName: 'pedestrian_phys_cond_incapacitated', query: function (input) { return createQueryClauseSingleton(this, tableName, input, ">"); } },
    { title: 'Pedestrian Physical Condition: Suspected Minor Injury', fieldName: 'pedestrian_phys_cond_moderate_injury', query: function (input) { return createQueryClauseSingleton(this, tableName, input, ">"); } },
    ...
    { title: 'Cyclist: Possible Injury', fieldName: 'cyclist_complaint_of_pain', query: function (input) { return createQueryClauseSingleton(this, tableName, input, ">"); } },
    {
