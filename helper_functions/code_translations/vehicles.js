...
// Vehicles table columns and code definitions
...
// *---------------*
const tableName = 'ard_vehicles_partition';
...
const filterDictonary = [
    ...
    {
        title: 'Driver Alcohol Result',
        fieldName: 'driver_alc_result',
        query: function (input) {
            return createQueryClauseSingleton(this, tableName, input);
        }
    },
    {
        title: 'Driver Alcohol Result Pending',
        fieldName: 'driver_alc_pending',
        query: function (input) {
            return createQueryClauseSingleton(this, tableName, input);
        }
    },
    ...
    {
        title: 'Vehicle Removed To',
        fieldName: 'removed_to',
        query: function (input) {
            return createQueryClauseSingleton(this, tableName, input);
        }
    },
    ...
    },
    {
        ...
        values: [
            { code: '00', description: 'Unknown' },
            { code: '01', description: 'Car/Station Wagon/Minivan' },
            { code: '02', description: 'Passenger Van (< 9 Seats)' },
            { code: '03', description: 'Cargo Van (10K lbs or less)' },
            { code: '04', description: 'Sport Utility Vehicle' },
            ...
            { code: '14', description: 'Golf Cart ' },
            { code: '15', description: 'Low Speed Vehicle ' },
            { code: '16', description: 'Snowmobile' },
            { code: '19', description: 'Other Passenger Vehicle' },
            ...
            { code: '30', description: 'Bus/Large Van/Limo (9-15 Seats)' },
            { code: '31', description: 'Bus (More than 15 Seats)' },
            { code: '40', description: 'Equipment/Machinery' },
            { code: '99', description: 'Other' },
            { code: '-20', description: 'Not Recorded' }
        ],
        query: function (input) {
    ...
    },
    {
        ...
        values: [
            ...
            { code: '12', description: 'Veh Used as Snnowplow' },
    ...
    },
    {
        ...
        values: [
            ...
            { code: '10', description: 'Hopper (grain' },
    ...
    },
    {
        ...
        moduleName: 'contr_circum_code_vehicles',
    ...
    },
    {
        ...
        fieldName: 'driver_phys_stat_code1',
        secondaryColumns: ['driver_phys_stat_code2'],
        values: [
            { code: '00', description: 'Unknown' },
    ...
    },
    {
        ...
        fieldName: 'driver_phys_stat_code2',
        values: [
            { code: '00', description: 'Unknown' },
            { code: '01', description: 'Apparently Normal' },
            { code: '02', description: 'Alcohol Use' },
    ...
    },
    {
        ...
        secondaryColumns: ['second_event_code', 'third_event_code', 'fourth_event_code'],
        values: [
            ...
            { code: '07', description: 'Cross Median' },
            { code: '08', description: 'Crossed Centerline' },
            { code: '09', description: 'Cargo / Equip Loss or Shift' },
            ...
            { code: '13', description: 'Equipment Failure(blown tire / brake failure / etc.)' },
            { code: '14', description: 'Downhill Runaway' },
            { code: '15', description: 'Reentered Roadway' },
            ...
            { code: '29', description: 'Work Zone / Maintenance Equipment' },
            ...
            { code: '46', description: 'Guide Rail Face' },
            { code: '47', description: 'Guide Rail End' },
    ...
    {
        title: 'Hazmat Placard',
        fieldName: 'hazmat_placard',
        query: function (input) {
            return createQueryClauseSingleton(this, tableName, input);
        }
    },
    ...
    {
        title: 'Hit and Run Crash',
        fieldName: 'flg_hit_run',
        query: function (input) {
            return createQueryClauseSingleton(this, tableName, input);
        }
    },
