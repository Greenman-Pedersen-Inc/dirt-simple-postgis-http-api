...
// *---------------*
const schema = {
    description: "Gets summation of crashes between 12PM and 23:59AM groupbed by Alcohol Inv/Hit Run and Compl.Pain/Total Crashes.",
    tags: ['ped-dashboard'],
    summary: "Gets summation of crashes between 12PM and 23:59AM groupbed by Alcohol Inv/Hit Run and Compl.Pain/Total Crashes.",
    querystring: {
        startYear: {
            type: 'string',
