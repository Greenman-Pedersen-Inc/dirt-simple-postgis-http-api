// ped_cyclist_breakdown: Gets summation of pedestrian crash count and cyclist crash count
...
const sql = (queryArgs) => {
    var sql = `
    SELECT 
    SUM(CASE WHEN cyclist_involved > 0 THEN 1 ELSE 0 END) cyclist_involved,
    SUM(CASE WHEN ped_involved > 0 THEN 1 ELSE 0 END) ped_involved,
    SUM(coalesce(cyclist_involved, 0)) cyclist_involved_persons, 
    SUM(coalesce(ped_involved, 0)) ped_involved_persons
...
// *---------------*
const schema = {
    description: "Gets summation of pedestrian crash count and cyclist crash count.",
    tags: ['ped-dashboard'],
    summary: "Gets summation of pedestrian crash count and cyclist crash count.",
    querystring: {
        startYear: {
            type: 'string',
